 ...
 *
 * It was 43 until outfitkit#134: `whatsapp_inbox` dropped its templates screen, so the demo that
 * declared `whatsapp_inbox.templates.list` was retired with it. The floor tracks how many demos
